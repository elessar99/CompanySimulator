...
namespace CompanySimulator.Presentation.UI.Runtime.Components
{
    ...
    public sealed class RivalCompanyPanelUI : MonoBehaviour
    {
        ...
        {
            var button = RuntimePanelUiUtility.CreateDesktopAppButton(RuntimePanelUiUtility.GetOrCreateComputerDesktopIconRoot(rootCanvas), defaultFont, "RivalCompanyOpenButton", "Rakip Şirketler", appIcon, "RIV", ColRed);
