...
namespace CompanySimulator.Presentation.UI.Runtime.Components
{
    ...
    public sealed class SecurityPanelUI : MonoBehaviour
    {
        ...
        {
            var button = RuntimePanelUiUtility.CreateDesktopAppButton(RuntimePanelUiUtility.GetOrCreateComputerDesktopIconRoot(rootCanvas), defaultFont, "SecurityOpenButton", "Güvenlik", appIcon, "GUV", ColPurple);
